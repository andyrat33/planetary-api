  ...
  stages {
    ...
    stage('Postman Tests') {
      ...
      steps {
        ...
        sh 'newman run planetary-api.postman_collection.json -e Planetary-API-Environment.postman_environment.json --reporters cli,junit,html --reporter-junit-export "newmman/reportxmml" --reporter-html-export "newman/report.html"'
        }
